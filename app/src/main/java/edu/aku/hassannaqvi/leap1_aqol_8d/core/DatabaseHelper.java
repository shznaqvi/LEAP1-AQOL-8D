...
import edu.aku.hassannaqvi.leap1_aqol_8d.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.leap1_aqol_8d.contracts.UsersContract;
import edu.aku.hassannaqvi.leap1_aqol_8d.contracts.UsersContract.singleUser;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "leap1-aqol-8d.db";
    public static final String DB_NAME = "leap1-aqol-8d_copy.db";
